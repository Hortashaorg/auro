...
test("@target admin can add a resource reward and a cost", async ({ page }) => {
  ...
  await page.goto(
    "http://localhost:4000/games/5bbcb026-e240-48d8-b66d-7105df74cf9f/admin/actions/5bbcb026-e240-48d8-b66d-7105df74cf9f",
  );
...
test("player is redirected from action admin page", async ({ page }) => {
  ...
  expect(page.url()).toBe("http://localhost:4000/games");
});
